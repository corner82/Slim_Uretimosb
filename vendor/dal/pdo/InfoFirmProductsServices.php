 ...
 * @author Okan CİRANĞ
 */
class InfoFirmProductsServices extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ info_firm_products_services tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    public function delete($params = array()) {
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($userId)) {
                ...
                UPDATE info_firm_products_services
    ...
    /**
     * @author Okan CIRAN
     * @ info_firm_products_services tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  20.06.2016   
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ info_firm_products_services tablosunda name sutununda daha önce oluşturulmuş mu? 
    ...
    /**
     * @author Okan CIRAN
     * @ info_firm_products_services tablosundan parametre olarak  gelen id kaydını aktifliğini 1 = pasif yapar. !!
     * @version v 1.0  18.05.2016
     * @param type $params
     * @return array
     * @throws \PDOException
    ...
    /**
     * @author Okan CIRAN
     * @ info_firm_products_services tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  18.05.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (\Utill\Dal\Helper::haveRecord($getFirm)) {
                    ...
                    if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                        ...
                        $ConsultantId = 1001;
                        $getConsultant = SysOsbConsultants::getConsultantIdForTableName(array('table_name' => 'info_firm_products_services' , 
                        ...
                        $sql = " 
                        INSERT INTO info_firm_products_services(
                            firm_id, 
                            consultant_id,
                            operation_type_id,
                            language_id,
                        ...
                        VALUES (
                            ...
                            (SELECT last_value FROM info_firm_products_services_id_seq),                           
                            :unspsc_codes_id                            
                             )";
                        $statement = $pdo->prepare($sql);
                      ...
                      //  echo debugPDO($sql, $params);
                        ...
                        $insertID = $pdo->lastInsertId('info_firm_products_services_id_seq');
                        $errorInfo = $statement->errorInfo();
                        if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                            throw new \PDOException($errorInfo[0]);
    ...
    /**
     * @author Okan CIRAN
     * info_firm_products_services tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  20.06.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (\Utill\Dal\Helper::haveRecord($kontrol)) {
                 ...
                 INSERT INTO info_firm_products_services(
                        ...
                        FROM info_firm_products_services 
                   ...
                   $consIdAndLanguageId = SysOperationTypes::getConsIdAndLanguageId(
                                   array('table_name' => 'info_firm_products_services', 'id' => $params['id'],));
    ...
    /**     
     * @author Okan CIRAN
     * @ Gridi doldurmak için info_firm_products_services tablosundan kayıtları döndürür !!
     * @version v 1.0  20.06.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
    ...
    /**     
     * @author Okan CIRAN
     * @ Gridi doldurmak için info_firm_products_services tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  20.06.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
