 ...
 * @author Okan CIRAN
 */
class LogConsultant extends \DAL\DalSlim {

    /**
     * @author Okan CIRAN
     * @ consultant_log tablosundan parametre olarak  gelen id kaydını siler. !!
    ...
    /**
     * @author Okan CIRAN
     * @ consultant_log tablosundaki tüm kayıtları getirir.  !!
     * @version v 1.0  10.03.2016  
     * @param array $params
     * @return array
     * @throws \PDOException
    ...
    /**   
     * @author Okan CIRAN
     * @ consultant_log tablosuna yeni bir kayıt oluşturur.  !!
     * @version v 1.0  10.03.2016
     * @param type $params
     * @return array
     * @throws \PDOException
        ...
        try {
            ...
            $pdo->beginTransaction();            
               ...
               // echo debugPDO($sql, $params);
                ...
                $insertID = $pdo->lastInsertId('consultant_log_id_seq');
                $errorInfo = $statement->errorInfo();
                if ($errorInfo[0] != "00000" && $errorInfo[1] != NULL && $errorInfo[2] != NULL)
                    throw new \PDOException($errorInfo[0]);
                $pdo->commit();
    ...
    /**
     * @author Okan CIRAN
     * consultant_log tablosuna parametre olarak gelen id deki kaydın bilgilerini günceller   !!
     * @version v 1.0  10.03.2016
     * @param type $params
     * @return array
     * @throws \PDOException
     ...
     * @author Okan CIRAN
     * @ Gridi doldurmak için consultant_log tablosundan kayıtları döndürür !!
     * @version v 1.0  10.03.2016
    ...
    /**
     * @author Okan CIRAN
     * @ Gridi doldurmak için consultant_log tablosundan çekilen kayıtlarının kaç tane olduğunu döndürür   !!
     * @version v 1.0  10.03.2016
     * @param array | null $args
     * @return array
     * @throws \PDOException
