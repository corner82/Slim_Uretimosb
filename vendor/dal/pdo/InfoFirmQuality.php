                ...
                if (\Utill\Dal\Helper::haveRecord($getFirm)) {
                    ...
                    if (!\Utill\Dal\Helper::haveRecord($kontrol)) {
                        ...
                        $operationId = SysOperationTypes::getTypeIdToGoOperationId(
                                        array('parent_id' => 3, 'main_group' => 3, 'sub_grup_id' => 24, 'type_id' => 1,));
                        ...
                        $ConsultantId = 1001;
                        $getConsultant = SysOsbConsultants::getConsultantIdForTableName(array('table_name' => 'info_firm_quality' , 
        ...
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                if (\Utill\Dal\Helper::haveRecord($kontrol)) {
                    ...
                    $operationIdValue = -2;
                    $operationId = SysOperationTypes::getTypeIdToGoOperationId(
                                array('parent_id' => 3, 'main_group' => 3, 'sub_grup_id' => 24, 'type_id' => 2,));
                    if (\Utill\Dal\Helper::haveRecord($operationId)) {
                    $operationIdValue = $operationId ['resultSet'][0]['id'];
                    }
                    $languageId = NULL;
                 ...
                 INSERT INTO info_firm_quality(
                    ...
                    */
                    $consIdAndLanguageId = SysOperationTypes::getConsIdAndLanguageId(
                                    array('table_name' => 'info_firm_quality', 'id' => $params['id'],));
    ...
    public function deletedAct($params = array()) {
        try {
            ...
            if (\Utill\Dal\Helper::haveRecord($opUserId)) {
                ...
                $operationIdValue = -3;
                $operationId = SysOperationTypes::getTypeIdToGoOperationId(
                                array('parent_id' => 3, 'main_group' => 3, 'sub_grup_id' => 24, 'type_id' => 3,));
                if (\Utill\Dal\Helper::haveRecord($operationId)) {
                    $operationIdValue = $operationId ['resultSet'][0]['id'];
                }
                $sql = "                
